...
class BatchIntegrationTest {
    ...
    void testJobExecution() throws Exception {
        ...
        System.out.println("These logs were successfully converted and passed to the OpenTelemetry Exporter:");
        System.out.println("--------------------------------------------------------------------------------");
        for (LogRecordData log : EXPORTED_LOGS) {
            System.out.println("Timestamp: " + log.getTimestampEpochNanos() + " (nanos)");
            System.out.println("Severity: " + log.getSeverityText() + " (" + log.getSeverity() + ")");
